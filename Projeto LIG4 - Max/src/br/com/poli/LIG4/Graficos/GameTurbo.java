...
import br.com.poli.LIG4.Game.ModeTurbo;
...
public class GameTurbo extends javax.swing.JFrame implements GameConnection{
    ...
    public GameTurbo(Player p1, Player p2, boolean b, Ranking r) throws IOException {
        this.move = true;
        this.choice = 0;
        this.gameOn = true;
        this.playing = p1;
        this.standby = p2;
        this.game = new ModeTurbo(p1,p2, b);
        this.ranking = r;
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(player1);
        player1.setBounds(760, 170, 170, 40);
