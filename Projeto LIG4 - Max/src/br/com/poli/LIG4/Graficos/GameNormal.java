...
import br.com.poli.LIG4.Game.ModeNormal;
...
public class GameNormal extends javax.swing.JFrame implements GameConnection {
    ...
    private ModeNormal game;
    
    public GameNormal(Player p1, Player p2, boolean b, Ranking r) throws IOException {
        this.move = false;
        this.choice = 0;
        this.gameOn = true;
        this.playing = p1;
        this.standby = p2;
        this.game = new ModeNormal(p1,p2, b);
        this.ranking = r;
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(player2);
        player2.setBounds(760, 300, 150, 40);
    ...
    private void left_buttonMouseClicked(java.awt.event.MouseEvent evt) {                                         
        // TODO add your handling code here:
    }                                        

    private void return_buttonMouseClicked(java.awt.event.MouseEvent evt) {                                           
        // TODO add your handling code here:
    }                                          
    ...
    public void endTest() throws IOException{
        ...
        boolean test = game.endGame(game.getOnePoint());
        if(test == true){
