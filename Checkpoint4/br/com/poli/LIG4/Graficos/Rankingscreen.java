...
public class Rankingscreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        winsP1.setText(ranking.players.get(0).getWins() + " vitorias");
        jPanel1.add(winsP1);
        ...
        if(ranking.players.size() > 1){
            winsP2.setText(ranking.players.get(1).getWins() + " vitorias");
        }
        jPanel1.add(winsP2);
        ...
        if(ranking.players.size() > 2){
            winsP3.setText(ranking.players.get(2).getWins() + " vitorias");
        }
        jPanel1.add(winsP3);
        ...
        if(ranking.players.size() > 3){
            winsP4.setText(ranking.players.get(3).getWins() + " vitorias");
        }
        jPanel1.add(winsP4);
        ...
        if(ranking.players.size() > 4){
            winsP5.setText(ranking.players.get(4).getWins() + " vitorias");
        }
        jPanel1.add(winsP5);
        ...
        if(ranking.players.size() > 4){
            player5.setText(ranking.players.get(4).getName());
        }
        jPanel1.add(player5);
        ...
        if(ranking.players.size() > 3){
            player4.setText(ranking.players.get(3).getName());
        }
        jPanel1.add(player4);
        ...
        if(ranking.players.size() > 2){
            player3.setText(ranking.players.get(2).getName());
        }
        jPanel1.add(player3);
        ...
        if(ranking.players.size() > 1){
            player2.setText(ranking.players.get(1).getName());
        }
        jPanel1.add(player2);
        ...
        player1.setText(ranking.players.get(0).getName());
        jPanel1.add(player1);
